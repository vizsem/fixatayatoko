...
import { Store, Package, ArrowLeft, Sparkles, ChevronRight, Loader2 } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
             ...
             <div className="flex flex-col">
                ...
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Kategori Otomatis</span>
             </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {loading ? (
          <div className="flex flex-col items-center py-20 text-gray-400">
            ...
            <p className="font-bold uppercase text-[10px] tracking-widest">Sinkronisasi Kategori...</p>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/kategori/promo" className="bg-red-50 border border-red-100 rounded-[2rem] p-6 text-center shadow-sm active:scale-95 transition-all">
              ...
              <h2 className="font-black text-[11px] uppercase text-red-600">Promo Produk</h2>
              <div className="mt-2 text-[8px] font-black text-red-400 uppercase animate-pulse">Diskon Spesial</div>
            </Link>
            ...
            {categories.map((cat, index) => (
              ...
              >
                ...
                <h2 className="font-black text-[11px] uppercase tracking-tighter text-gray-800 group-hover:text-green-600">
                  {cat.name}
                </h2>
              </Link>
            ))}
        ...
        <div className="mt-12 bg-green-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-xl font-black uppercase mb-2">Update Stok Otomatis</h2>
            <p className="text-green-100 text-[10px] mb-6 font-bold uppercase tracking-widest opacity-80">
