    ...
    <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm flex flex-col overflow-hidden h-fit">
      <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-lg font-black text-slate-800 tracking-tight">Riwayat Transaksi Marketplace</h3>
        </div>
      </div>
      <div className="overflow-x-auto max-h-[600px] no-scrollbar">
        {logs.length === 0 ? (
          <div className="p-16 text-center">
             ...
             <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Belum ada riwayat transaksi</p>
          </div>
        ) : (
